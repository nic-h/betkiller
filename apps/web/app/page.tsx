  ...
  return (
    <main className="bk-space-y-6 bk-p-6">
      <header className="bk-flex bk-flex-wrap bk-items-center bk-justify-between bk-gap-4">
        ...
        {me && (
          <div className="bk-rounded-full bk-bg-brand-blue/10 bk-px-4 bk-py-2 bk-text-sm">
      ...
      <section className="bk-grid bk-grid-cols-1 xl:bk-grid-cols-[2fr,1fr] bk-gap-6">
        <div className="bk-space-y-6">
          ...
          <div className="bk-rounded-2xl bk-bg-brand-panel bk-ring-1 bk-ring-brand-ring bk-p-4 bk-space-y-3">
            <header className="bk-flex bk-items-center bk-justify-between">
              <h2 className="bk-text-sm bk-uppercase bk-tracking-widest bk-text-brand-muted">Action Bar</h2>
        ...
        <div className="bk-space-y-6">
          <section className="bk-rounded-2xl bk-bg-brand-panel bk-ring-1 bk-ring-brand-ring bk-p-4 bk-space-y-3">
            <header className="bk-flex bk-items-center bk-justify-between">
              <div>
                <h2 className="bk-text-sm bk-uppercase bk-tracking-widest bk-text-brand-muted">My Rewards</h2>
                <p className="bk-text-xs bk-text-brand-muted">Past 14 days by bucket</p>
              </div>
            </header>
